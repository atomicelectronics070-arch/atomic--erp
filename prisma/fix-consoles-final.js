...
async function main() {
    ...
    console.log(`Updating ${products.length} products in Consolas category...`)

    for (const p of products) {
        let imageUrl = 'https://m.media-amazon.com/images/I/6127XFzU+UL._AC_SL1500_.jpg'; // Controller as fallback
