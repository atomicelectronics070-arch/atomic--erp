export default function DashboardLoading() {
    return (
        <div className="flex h-screen w-full items-center justify-center bg-slate-900/50 backdrop-blur-xl border-slate-700/50/50 backdrop-blur-sm fixed inset-0 z-50">
