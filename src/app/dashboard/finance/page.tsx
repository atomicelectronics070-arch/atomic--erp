            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-10 border-b border-white/5 pb-16 relative z-10">
                <div>
                    ...
                    <div className="flex items-center gap-6 mt-6">
                       <div className="glass-panel !bg-secondary/10 px-6 py-2 rounded-full border border-secondary/20 shadow-[0_0_20px_rgba(255,99,71,0.15)]">
                ...
                <button className="bg-secondary text-white px-12 py-6 font-black uppercase tracking-[0.3em] text-[10px] flex items-center shadow-[0_20px_50px_-10px_rgba(255,99,71,0.5)] transition-all hover:bg-white hover:text-secondary rounded-2xl active:scale-95 group italic skew-x-[-12deg]">
