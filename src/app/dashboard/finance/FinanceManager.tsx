                                ...
                                <tr key={item.id} className="hover:bg-white/[0.04] transition-all group relative">
                                    ...
                                    <td className="px-12 py-8">
                                        ...
                                        <div className="flex items-center gap-3">
                                            <span className="w-1.5 h-1.5 rounded-none bg-azure-500 animate-pulse" />
                                    ...
                                    <td className="px-12 py-8 text-center">
                                        <div className="flex flex-col items-center gap-2">
                                            <span className={`px-6 py-2.5 rounded-none text-[9px] font-black uppercase tracking-[0.4em] border italic shadow-2xl ${
                                        ...
                                        <div className="flex justify-end space-x-3 opacity-0 group-hover:opacity-100 transition-all translate-x-10 group-hover:translate-x-0">
                                            {isAdmin && item.status === "PENDIENTE" && (
                                                <button
                                                    ...
                                                    className="p-4 glass-panel !bg-emerald-500/10 text-emerald-400 hover:text-white hover:bg-emerald-500 transition-all rounded-none border-white/5 shadow-2xl"
                                                >
                                                    <ShieldCheck size={20} />
                                                </button>
                                            )}
                                            {isAdmin && (
                                                <>
                                                    <button
                                                        ...
                                                        className="p-4 glass-panel !bg-slate-900 text-slate-600 hover:text-secondary hover:bg-white transition-all rounded-none border-white/5 shadow-2xl"
                                                    >
                                                        <Edit3 size={20} />
                                                    </button>
                                                    <button
                                                        onClick={() => handleDelete(item.id)}
                                                        className="p-4 glass-panel !bg-slate-900 text-slate-600 hover:text-red-500 hover:bg-red-500/10 transition-all rounded-none border-white/5 shadow-2xl"
                                                    >
                                                        <Trash2 size={20} />
                                                    </button>
                                                </>
                                            ...
                                            >
                                                <div className="space-y-4">
                                                    ...
                                                    <input
                                                        ...
                                                        className="w-full bg-slate-950/60 border border-white/5 rounded-none py-6 px-10 text-xl font-black text-slate-400 focus:border-secondary outline-none italic"
                                                    />
                                                </div>
                                                <div className="space-y-4">
                                                    ...
                                                    <input
                                                        ...
                                                        className="w-full bg-secondary/5 border border-secondary/20 rounded-none py-6 px-10 text-2xl font-black text-secondary focus:border-secondary outline-none italic"
                                                    />
                                                </div>
                                                <div className="col-span-2 space-y-4">
