...
import { Cpu, Zap, Video, FileText, Database, ShieldCheck } from "lucide-react"

export default function AcademyAutomationClient() {
    ...
    const startAutomation = async () => {
        ...
        try {
            ...
            addLog(`MÓDULOS DETECTADOS: ${plan.segments?.length || 0}`)

            setStatus("CUTTING")
            setProgress(40)
            addLog("INVOCANDO FFmpeg PARA SEGMENTACIÓN SIN PÉRDIDA...")
            await fetch("/api/academy/automate", {
                method: "POST",
                headers: { "Content-Type": "application/json" },
    ...
    return (
        <div className="p-8 space-y-12 max-w-[1600px] mx-auto">
            <div className="flex flex-col md:flex-row justify-between items-end gap-10 border-b border-white/[0.03] pb-10">
                ...
                <div className="bg-slate-900/50 backdrop-blur-xl p-6 border border-white/[0.03]">
                ...
                <div className="lg:col-span-3 space-y-10">
                    <div className="glass-panel p-10 space-y-12 !bg-slate-950/20 border-white/[0.03]">
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="h-[2px] bg-slate-900/50 overflow-hidden">
                                <motion.div 
                                    initial={{ width: 0 }}
                            ...
                            <div className="grid grid-cols-4 gap-6">
                                {[
                                    { icon: <Cpu size={14} />, label: "PLANNING", active: progress >= 15 },
                    ...
                    <AnimatePresence>
                        {courseData && (
                            <motion.div 
                                ...
                                className="glass-panel p-10 !bg-slate-900/50 border-white/[0.03]"
                            >
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    {courseData.segments?.map((s: any, i: number) => (
                                        <div key={i} className="flex items-center justify-between p-5 bg-slate-900/50 border border-white/[0.02]">
