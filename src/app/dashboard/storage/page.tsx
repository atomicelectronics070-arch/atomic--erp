    ...
    return (
        <div className="space-y-16 pb-40 animate-in fade-in duration-1000 relative">
            ...
            <div className="flex flex-col xl:flex-row justify-between items-start xl:items-end gap-12 border-b border-white/10 pb-20 relative z-10">
                <div>
                     <div className="flex items-center space-x-6 mb-6 text-secondary">
                        ...
                        <span className="text-[11px] uppercase font-black tracking-[0.8em] italic">Gesti�n de Archivos</span>
                    </div>
                    ...
                    <p className="text-slate-500 font-bold text-xs uppercase tracking-[0.4em] mt-7 max-w-2xl italic leading-relaxed opacity-80">
                        Una unidad sencilla e intuitiva para gestionar todos tus documentos y activos digitales en un solo lugar.
                    </p>
                </div>
            ...
            <div className="glass-panel !bg-slate-950/70 p-8 flex flex-wrap items-center gap-6 text-[11px] font-black uppercase tracking-[0.5em] shadow-[0_40px_100px_-20px_rgba(0,0,0,0.8)] relative z-10 rounded-none-[2.5rem] border-white/10 backdrop-blur-[50px] italic ring-1 ring-white/5">
                ...
                {/* Visual Storage Meter - Corporativo */}
                <div className="ms-auto hidden lg:flex items-center gap-10 py-2 px-12 border-s border-white/10">
                    <div className="text-right space-y-2">
                        <p className="text-[9px] text-slate-700 font-black tracking-widest">SATURACIÓN_Elemento</p>
                ...
                <div className="p-8">
                    {isLoading ? (
                        <div className="flex flex-col items-center justify-center h-96 space-y-10">
                            ...
                            <p className="text-[11px] font-black text-slate-700 uppercase tracking-[1em] italic animate-pulse">DetallesORÍA DE DIRECTORIO v4.0...</p>
                        </div>
                        ...
                        <div className="flex flex-col items-center justify-center h-96 text-slate-800 opacity-30 group">
                            ...
                            <p className="text-[14px] font-black uppercase tracking-[1em] italic">Elemento DESIERTO</p>
                            <p className="text-[10px] font-black uppercase tracking-[0.5em] mt-5 italic">Sin archivos: Ningún Activo Detectado</p>
                        </div>
                    ) : (
            ...
            {/* Modal: New Folder - Corporativo Redesign */}
            <AnimatePresence>
                {showNewFolder && (
                        ...
                        >
                            <div className="flex items-center gap-8 mb-16">
                                ...
                                <div>
                                    ...
                                    <p className="text-[11px] font-black text-slate-700 uppercase tracking-[0.6em] mt-4 italic">Sistema de Organizaci�n de Archivos</p>
                                </div>
                            </div>
            ...
            {/* Modal: Upload File (Simulated) - Corporativo Redesign */}
            <AnimatePresence>
                {showUpload && (
                    <div className="fixed inset-0 z-[400] flex items-center justify-center p-12">
                        <motion.div 
                        ...
                        >
                            <div className="flex items-center gap-10 mb-12">
                                ...
                                <div>
                                    <h3 className="text-5xl font-black uppercase italic tracking-tighter text-white leading-none">
                                        Subir <span className="text-azure-400">ACTIVO</span>
                                    </h3>
                                    <p className="text-[11px] font-black text-slate-700 uppercase tracking-[0.6em] mt-5 italic">Carga de Archivos a la Nube</p>
                                </div>
                            </div>
                            ...
                            <p className="text-[11px] text-slate-500 mb-16 uppercase tracking-[0.4em] italic font-bold leading-relaxed border-l-4 border-azure-500/30 pl-8 bg-azure-500/5 py-6 rounded-none">
                                <span className="text-azure-400">Detalles:</span> EL SOPORTE PARA CARGA DIRECTA S3 ESTÁ EN SINTONÍA. INGRESE URL REFERENCIAL DEL Elemento DIGITAL PARA ENCRIPTACIÓN.
                            </p>
