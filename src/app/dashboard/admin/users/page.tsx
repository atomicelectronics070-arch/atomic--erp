        ...
        <div className="space-y-16 pb-24">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                <div>
                    ...
                    <p className="text-neutral-400 font-medium text-sm mt-1">Nivel Corporativo: Control de acceso y estructura organizacional corporativa.</p>
                </div>
            </div>
            ...
            <div className="pt-16 border-t border-neutral-100">
                <div className="flex items-center space-x-3 mb-8">
                    ...
                    <h2 className="text-xl font-bold uppercase tracking-tight">Administración de Perfiles y Rendimiento</h2>
                </div>
            ...
            <div className="bg-neutral-900 p-8 flex items-start space-x-4">
                ...
                <p className="text-xs text-neutral-500 leading-relaxed uppercase font-bold tracking-widest">
                    Seguridad: Toda acción de eliminación o cambio de rol queda registrada en el log de Detallesoría del sistema.
                </p>
            </div>
        </div>
    )
