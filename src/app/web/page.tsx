                                    ...
                                    <div className="p-4 flex-1 flex flex-col justify-center bg-transparent transition-colors">
                                        ...
                                        <div className="flex flex-col">
                                            {userRole && (userRole === 'AFILIADO' || userRole === 'DISTRIBUIDOR') && (
                                                <p className="text-[9px] text-white/30 line-through font-mono decoration-[#E8341A]/50">
                                    ...
                                    >
                                        ...
                                        <div className="p-4 border-t border-white/5">
                                            ...
                                            <div className="flex flex-col mt-2">
                                                {userRole && (userRole === 'AFILIADO' || userRole === 'DISTRIBUIDOR') && (
                                                    <p className="text-[8px] text-white/20 line-through font-mono">
                                                        ${p.price?.toLocaleString('en-US', { minimumFractionDigits: 2 }) || '0.00'}
                                                    </p>
                                                )}
                                                <p className="text-white/80 text-[11px] font-black font-mono" style={{ color: accent }}>
                                                    ${calculateDiscountedPrice(p.price, userRole).toLocaleString('en-US', { minimumFractionDigits: 2 })}
                                                </p>
                                            </div>
                                        </div>
                ...
                <div className="max-w-[95%] mx-auto px-6 mb-12 flex flex-col md:flex-row items-end justify-between gap-6">
                    <div className="space-y-2">
                        ...
                        <h2 className="text-4xl md:text-5xl font-black text-white uppercase tracking-tighter leading-none">
                            Categorías <span className="text-transparent bg-clip-text bg-gradient-to-r from-white to-white/50 italic">Corporativoes</span>
                        </h2>
                    </div>
