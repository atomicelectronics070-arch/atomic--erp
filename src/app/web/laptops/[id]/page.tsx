...
import InteractiveImageCarousel from '@/components/ui/InteractiveImageCarousel';
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-800 pb-24 font-sans selection:bg-blue-500 selection:text-white">
      ...
      <div className="max-w-7xl mx-auto px-6 mt-12 grid lg:grid-cols-2 gap-12 lg:gap-20">
        ...
        {/* Mega Galería Visual - Carrusel Interactivo */}
        <div className="w-full">
          <InteractiveImageCarousel photos={photos} productName={product.name} />
        </div>
        ...
        <div className="flex flex-col pt-4">
          <div className="mb-10">
            ...
            <Link 
              href="/web/repuestos"
              className="mt-6 w-full py-4 px-8 bg-slate-100 hover:bg-slate-200 text-slate-700 text-lg font-semibold rounded-[2rem] border border-slate-200 transition-all flex items-center justify-center gap-2 group"
            >
              <svg className="w-5 h-5 group-hover:-translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M10 19l-7-7m0 0l7-7m-7 7h18"></path></svg>
              Ver Todo el Catálogo de Laptops
            </Link>
          </div>
