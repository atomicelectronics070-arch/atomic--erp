...
import BobinasClient from "../bobinas-cables/BobinasClient";
...
export const metadata = {
  ...
  description:
    "Catálogo oficial de bobinas de cable de 305m y 1000m. Cables UTP, FTP, STP, Cat6, Cat5e, 100% Cobre Puro certificables Fluke y Aleaciones CCA para CCTV.",
};

export default async function CablesAliasLandingPage() {
  let products: any[] = [];
  try {
    ...
    console.error("Error fetching cable products in CablesAliasLandingPage:", error);
  }
