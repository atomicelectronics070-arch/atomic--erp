        ...
        <div className="min-h-screen bg-neutral-950 text-white font-sans selection:bg-indigo-500/30 overflow-hidden relative">
            ...
            <nav className="fixed top-0 w-full z-50 bg-slate-950/40 backdrop-blur-xl border-b border-white/5 px-6 py-4 flex items-center justify-between">
                <Link href="/web/blogs" className="group flex items-center space-x-3 text-white/50 hover:text-white transition-colors">
                    <div className="w-8 h-8 rounded-lg border border-white/10 flex items-center justify-center bg-white/5 group-hover:bg-white/10 group-hover:border-indigo-500 transition-colors">
                        <ArrowLeft size={16} />
                    </div>
                    <span className="text-[10px] font-black uppercase tracking-widest hidden sm:inline">Volver a Noticias</span>
                </Link>
                <div className="flex items-center space-x-3">
                    <div className="w-2.5 h-2.5 bg-indigo-500 shadow-[0_0_15px_rgba(99,102,241,0.8)] rounded-full"></div>
            ...
            <article className="relative z-10 pt-40 pb-32">
                ...
                <header className="max-w-4xl mx-auto px-6 text-center mb-16">
                    <div className="flex items-center justify-center space-x-6 mb-10 text-[10px] font-black uppercase tracking-[0.2em] text-white/40">
                        <div className="flex items-center space-x-2 bg-indigo-500/10 text-indigo-400 border border-indigo-500/20 px-3 py-1.5 rounded-full">
                            <Clock size={12} />
                    ...
                    {blog.excerpt && (
                        <div className="max-w-2xl mx-auto border-l-4 border-indigo-600 bg-white/5 backdrop-blur-md p-8 text-left rounded-r-2xl">
                ...
                {blog.imageUrl && (
                    <div className="w-full max-w-6xl mx-auto px-6 mb-24">
                        <div className="w-full aspect-video md:aspect-[21/9] bg-neutral-900 overflow-hidden relative shadow-[0_0_80px_rgba(0,0,0,0.5)] border border-white/5 rounded-3xl group">
                ...
                <div className="max-w-3xl mx-auto px-6">
                    <div 
                        className="prose prose-lg prose-invert md:prose-xl max-w-none prose-headings:font-black prose-headings:tracking-tight prose-headings:text-white prose-a:text-indigo-400 prose-img:rounded-3xl prose-img:shadow-2xl prose-p:text-white/70 prose-p:leading-relaxed prose-strong:text-indigo-300"
            ...
            <footer className="relative z-10 border-t border-white/5 bg-slate-950/20 px-6 py-20">
                <div className="max-w-4xl mx-auto text-center">
                    <Link href="/web/blogs" className="inline-flex items-center justify-center space-x-4 bg-indigo-600 text-white px-10 py-5 text-[10px] font-black uppercase tracking-widest hover:bg-white hover:text-indigo-600 transition-all shadow-2xl shadow-indigo-500/20 group rounded-full">
