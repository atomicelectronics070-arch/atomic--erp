    ...
    return (
        <div className="min-h-screen w-full flex items-center justify-center bg-[#07090E] p-4 sm:p-6 font-sans text-slate-100 relative overflow-hidden">
            ...
            <motion.div
                ...
                className="w-full max-w-[400px] rounded-3xl bg-[#0F1420] border border-amber-500/25 p-8 shadow-2xl relative z-10"
            >
                ...
                <form onSubmit={handleLoginSubmit} className="space-y-4">
                    <div>
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                placeholder="tecnico@atomic.com"
                                className="w-full bg-[#161D2E] border border-white/10 rounded-2xl pl-11 pr-4 py-3 text-xs text-white placeholder:text-slate-600 focus:outline-none focus:border-amber-400"
                            />
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                className="w-full bg-[#161D2E] border border-white/10 rounded-2xl pl-11 pr-11 py-3 text-xs text-white placeholder:text-slate-600 focus:outline-none focus:border-amber-400"
                            />
                            <button
                                type="button"
                    ...
                    <button
                        type="submit"
                        disabled={loading}
                        className="w-full py-3.5 rounded-2xl bg-gradient-to-r from-amber-600 to-orange-600 hover:from-amber-500 hover:to-orange-500 text-white font-bold text-xs uppercase tracking-wider transition-all shadow-lg shadow-amber-600/20 flex items-center justify-center gap-2 cursor-pointer"
                    >
                        {loading ? (
                            <>
                            ...
                            <>
                                Iniciar Sesión Técnico <ArrowRight size={14} />
                            </>
                        )}
                    </button>
                </form>
                ...
                <div className="mt-6 pt-4 border-t border-white/10 text-center space-y-2">
                    <p className="text-xs text-slate-400">
                        ...
                        <Link href="/register/tecnico" className="text-amber-400 font-bold hover:underline">
                            Registro Oficial de Técnicos
                        </Link>
                    </p>
                </div>
            </motion.div>
...
export default function TecnicoLoginPage() {
    return (
        <Suspense fallback={
            <div className="min-h-screen w-full flex items-center justify-center bg-[#07090E] text-amber-400">
