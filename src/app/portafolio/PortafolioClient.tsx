    ...
    <div className="min-h-screen bg-white text-neutral-900 font-sans antialiased selection:bg-blue-100 selection:text-blue-900">
      ...
      <footer className="border-t border-neutral-200 bg-neutral-50 text-neutral-600 mt-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          {/* Corporate Social Channels & Leadership Profiles */}
          <div className="mt-12 pt-8 border-t border-neutral-200 grid grid-cols-1 md:grid-cols-2 gap-6">
            {/* Column 1: Canales Oficiales ATOMIC */}
            <div className="p-5 rounded-2xl bg-white border border-neutral-200/90 shadow-sm flex flex-col justify-between">
              <div>
                <div className="text-[10px] font-bold uppercase tracking-widest text-blue-900 mb-1">
                  Canales Oficiales
                </div>
                <h6 className="text-sm font-extrabold text-neutral-950 tracking-tight mb-3">
                  Redes Sociales Institucionales ATOMIC
                </h6>
                <p className="text-xs text-neutral-500 mb-4">
                  Siga los canales oficiales de la empresa para novedades sobre productos, catálogo técnico y eventos corporativos.
                </p>
              </div>

              <div className="flex flex-wrap items-center gap-3 pt-3 border-t border-neutral-100">
                <a
                  href="https://www.facebook.com/share/1ByCPNwpYj/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 px-3.5 py-2 rounded-xl bg-neutral-50 hover:bg-blue-50 border border-neutral-200 hover:border-blue-300 text-neutral-800 hover:text-blue-950 text-xs font-semibold transition-all group"
                >
                  ...
                  <span>Facebook Oficial ATOMIC</span>
                  <ExternalLink className="w-3 h-3 text-neutral-400 group-hover:text-blue-900" />
                </a>

                <a
                  href="https://www.instagram.com/atomic_industries_26?stkn=bDczYW9xN2F6NXFs"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 px-3.5 py-2 rounded-xl bg-neutral-50 hover:bg-blue-50 border border-neutral-200 hover:border-blue-300 text-neutral-800 hover:text-blue-950 text-xs font-semibold transition-all group"
                >
                  <svg className="w-4 h-4 text-blue-800" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    <rect width="20" height="20" x="2" y="2" rx="5" ry="5"/>
                    <path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/>
                    <line x1="17.5" x2="17.51" y1="6.5" y2="6.5"/>
                  </svg>
                  <span>Instagram Oficial ATOMIC</span>
                  <ExternalLink className="w-3 h-3 text-neutral-400 group-hover:text-blue-900" />
                </a>
              </div>
            </div>

            {/* Column 2: Dirección Técnica y Marca Personal */}
            <div className="p-5 rounded-2xl bg-white border border-neutral-200/90 shadow-sm flex flex-col justify-between">
              <div>
                <div className="text-[10px] font-bold uppercase tracking-widest text-blue-900 mb-1">
                  Dirección & Liderazgo Técnico
                </div>
                <h6 className="text-sm font-extrabold text-neutral-950 tracking-tight mb-3">
                  Perfiles Directivos y Marca Personal
                </h6>
                <p className="text-xs text-neutral-500 mb-4">
                  Contacto directo con la jefatura técnica y dirección comercial para consultas especializadas, alianzas y asesoramiento en obra.
                </p>
              </div>

              <div className="flex flex-wrap items-center gap-3 pt-3 border-t border-neutral-100">
                {/* TikTok - Jefe Técnico y Propietario */}
                <a
                  href="https://www.tiktok.com/@santiagoguzman216?_r=1&_t=ZS-99mvBoRmNIW"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2.5 px-3.5 py-2 rounded-xl bg-neutral-50 hover:bg-neutral-100 border border-neutral-200 hover:border-neutral-400 text-neutral-900 text-xs font-semibold transition-all group"
                >
                  ...
                  <div>
                    <span className="block text-[9px] uppercase font-bold text-blue-900 leading-tight tracking-wider">TikTok • Dirección</span>
                    <span className="font-bold text-neutral-950">Jefe Técnico y Propietario</span>
                  </div>
                  <ExternalLink className="w-3 h-3 text-neutral-400 group-hover:text-neutral-900 ml-1" />
                </a>

                {/* Facebook - Director Comercial (Marca Personal) */}
                <a
                  href="https://www.facebook.com/share/19RTSTUTXY/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2.5 px-3.5 py-2 rounded-xl bg-neutral-50 hover:bg-blue-50 border border-neutral-200 hover:border-blue-300 text-neutral-900 text-xs font-semibold transition-all group"
                >
                  <svg className="w-4 h-4 text-blue-800" viewBox="0 0 24 24" fill="currentColor">
                    <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                  </svg>
                  <div>
                    <span className="block text-[9px] uppercase font-bold text-blue-900 leading-tight tracking-wider">Facebook • Marca Personal</span>
                    <span className="font-bold text-neutral-950">Director Comercial</span>
                  </div>
                  <ExternalLink className="w-3 h-3 text-neutral-400 group-hover:text-blue-900 ml-1" />
                </a>
              </div>
            </div>
          </div>
