...
const CONFIG = {
    ...
    iva: 1.15,
    categoryUrl: 'https://multitecnologiavyv.com/319-hub-usb',
    targetCategoryName: 'Hubs USB',
    parentCategoryId: 'cmqvwkn530000ejkxk6df8rqz', // Electrónica
    marginFactor: 1.35, // 35% margin flat (the same margin)
    chromePath: 'C:\\Program Files\\Google\\Chrome\\Application\\chrome.exe'
};

async function run() {
    console.log("🚀 Iniciando Sincronizador para Hubs USB (MultiTecnologia V&V)...");
    ...
    try {
        ...
        console.log(`\n🎉 Sincronización exitosa. Total productos en Hubs USB: ${totalItems}`);
