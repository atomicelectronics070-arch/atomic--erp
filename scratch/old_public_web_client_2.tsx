            ...
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.6 }} className="relative z-10">
                ...
                <section className="py-12" id="destacados">
                    <div className="max-w-7xl mx-auto px-6">
                        <div className="mb-6 flex items-end justify-between">
                            <div>
                                <h2 className="text-xl font-semibold text-[black] uppercase tracking-widest">
                                    PRODUCTOS <span className="font-bold text-black">DESTACADOS</span>
                                </h2>
                                <p className="text-slate-400 text-[10px] mt-1 uppercase tracking-[0.3em] font-medium">Selección Premium</p>
                            </div>
                            <Link href="/web/products" className="text-[10px] font-semibold text-slate-500 hover:text-black transition-colors flex items-center gap-1 uppercase tracking-widest">
                                Ver todos <ArrowRight size={12} />
                            </Link>
                        </div>
                    ...
                    <div className="max-w-7xl mx-auto px-6 mb-12">
                        <div className="flex flex-col md:flex-row md:items-center justify-between gap-8 mb-16">
                            <div className="space-y-2">
                                <h2 className="text-3xl md:text-5xl font-black text-[black] uppercase tracking-tighter italic">
                            ...
                            <div className="relative group w-full md:w-[400px]">
                                ...
                                <input 
                                    ...
                                    className="w-full bg-white border border-slate-200 rounded-none p-4 pl-12 pr-24 text-sm uppercase tracking-widest placeholder:text-slate-300 focus:border-[black] focus:bg-slate-50 transition-all outline-none"
                                />
                                <div className="absolute right-4 top-1/2 -translate-y-1/2 flex items-center gap-4">
                                    <div className="hidden sm:block px-2 py-0.5 bg-zinc-50 border border-zinc-200 rounded-none">
                                        <span className="text-[8px] font-black text-[black] uppercase tracking-widest">{filteredProducts.length} Items</span>
                                    </div>
                                    {searchQuery && (
                                        <button 
                    ...
                    <div className="max-w-7xl mx-auto px-6">
                        <div className="bg-white border border-slate-200 rounded-2xl overflow-hidden shadow-xl relative flex flex-col md:flex-row">
                            ...
                            >
                                ...
                                <h2 className="text-4xl md:text-5xl font-light text-[black] uppercase tracking-tight mb-4">
                                    ATOMIC <span className="font-bold text-black">ACADEMY</span>
                                </h2>
                                ...
                                <div className="flex gap-4">
                                    <Link href="/web/academy">
                                        <button className="bg-[black] text-white px-8 py-3 rounded-lg font-semibold uppercase tracking-widest text-[10px] hover:bg-blue-800 hover:-translate-y-0.5 transition-all shadow-lg">Acceder a Cursos</button>
                                    </Link>
                            ...
                            <motion.div
                                ...
                                viewport={{ once: true }}
                                className="w-full md:w-2/5 relative min-h-[220px] bg-gradient-to-br from-[black] to-blue-900 flex flex-col items-center justify-center p-10 overflow-hidden border-l border-slate-200"
                            >
                                <Hexagon size={80} className="text-black/10 absolute scale-[3] animate-[spin_60s_linear_infinite]" strokeWidth={0.5} />
                                <div className="relative z-10 text-center">
                                    <div className="text-2xl font-bold text-white tracking-tight mb-2 italic">NUEVOS CURSOS</div>
                                    <div className="text-[10px] font-semibold text-zinc-200 uppercase tracking-[0.4em] bg-blue-950/30 px-4 py-2 rounded-full border border-black/30">Disponibles Ahora</div>
                                </div>
                            </motion.div>
                        </div>
                    </div>
                ...
                <section className="py-10 border-t border-slate-200 mt-8">
                    <div className="max-w-7xl mx-auto px-6 grid grid-cols-2 md:grid-cols-4 gap-6">
                        {[
                            { icon: <Truck size={16} />, title: "Logística Global", desc: "Envíos rápidos", color: 'black' },
                            { icon: <Shield size={16} />, title: "Seguridad", desc: "Garantía total", color: 'black' },
                            { icon: <Zap size={16} />, title: "Rapidez", desc: "Pago en 1-Click", color: 'black' },
                            { icon: <Star size={16} />, title: "Soporte", desc: "Asistencia VIP", color: 'black' }
                        ].map((f, i) => (
                            <div key={i} className="flex items-center space-x-3">
                                <div style={{ color: f.color }} className="bg-slate-50 p-2.5 rounded-lg border border-slate-200 shrink-0">{f.icon}</div>
                                <div>
                                    <p className="text-[11px] font-semibold uppercase tracking-widest text-[black]">{f.title}</p>
    ...
    return (
        ...
        >
            ...
            >
                ...
                <div className="p-2">
                    <p className="text-[9px] font-medium text-slate-500 tracking-wide line-clamp-2 leading-tight group-hover:text-[black] transition-colors mb-1">{p.name}</p>
            ...
            >
                {products.map((p: any) => (
                    ...
                    >
                        ...
                        <div className="p-3">
                            <p className="text-[10px] font-medium text-slate-500 line-clamp-2 leading-snug mb-2 group-hover:text-[black] transition-colors">{p.name}</p>
                                ...
                                {products.map((p: any, idx: number) => (
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            <div className="px-1">
                                                <p className="text-slate-500 text-[11px] font-semibold line-clamp-2 mb-2 group-hover:text-[black] transition-colors leading-relaxed h-8">{p.name}</p>
